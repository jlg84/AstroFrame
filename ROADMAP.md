...
AstroFrame has moved well beyond the original 0.1 browser prototype. This roadmap reflects the current 1.0 release-candidate application.
...
- [x] Filename/subject hints before remote fallback
- [x] Persistent solution cache
- [x] Multiple telescope/camera equipment profiles
- [x] Accurate FOV overlays and rotation
- [x] Equipment Advisor and alternative-rig suggestions
- [x] Multiple observing sites and adjustable horizon
- [x] Observability windows with extended look-ahead
- [x] User catalogue/collection import and removal
- [x] Full-precision catalogue-coordinate handling
- [x] Canonical duplicate-object markers and coordinate arbitration
...
- [ ] Broaden automated regression coverage
- [ ] Continue improving catalogue identity/alias coverage
